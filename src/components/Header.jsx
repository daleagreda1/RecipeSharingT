    ...
    <header className="Headercontainer py-8 bg-gray-100 text-white p-6 drop-shadow-md w-full">
      <div className="container mx-auto flex flex-wrap justify-between items-center">
        ...
        <div>
          ...
          <button className="SubmitButtonHeader text-sm p-[12px] rounded-full hover:bg-white hover:text-green-600 border-green-400 border-2 w-auto md:w-auto"> Share your Recipe! </button>
          </a>
        </div>
      </div>
    </header>
