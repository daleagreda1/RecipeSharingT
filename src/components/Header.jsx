  ...
  return (
    <header className="Headercontainer py-8 bg-gray-100 text-white p-6 drop-shadow-md w-full">
      <div className="container mx-auto flex flex-wrap justify-between items-center">
        ...
        <nav className="flex flex-row md:flex-row text-align-left justify-start md:space-x-20 w-full md:w-auto text-sm mb-4 md:mb-0 gap-y-5 gap-x-10 md:gap-x-2 pr-[28rem] font-semibold">
          ...
          <a href='/#About-Us' className="hover:text-gray-40 text-black transition-transform duration-300 hover:scale-105">About us</a>
